...
htmlhelp_basename = 'GEM-Control-doc'
...
man_pages = [
    (master_doc, 'gem-control', 'GEM-Control Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GEM-Control', 'GEM-Control Documentation',
     author, 'GEM-Control', 'A package to control gym-electric-motor (GEM) environments with classical PI-controllers.',
     'Miscellaneous'),
]
